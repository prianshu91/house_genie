 ...
 * @version 1.0
 */
public class ProductMessageMapper implements
		MongoMapper<ProductMessage, ProductMessageFilter> {
	...
	@Override
	public BasicDBObject convertToDao(ProductMessage dto) {
		...
		MongoUtils.appendToObj(obj, PRODUCT_TITLE, dto.getProductTitle());
	...
	@Override
	public BasicDBObject convertToDao(ProductMessageFilter filter) {
		BasicDBObject obj = new BasicDBObject();
		if (filter == null) {
			return obj;
		}
	...
	@Override
	public ProductMessage convertToDto(BasicDBObject obj) {
		ProductMessage dto = new ProductMessage();
		...
		dto.setProductTitle(obj.getString(PRODUCT_TITLE));

 ...
 * @version 1.0
 */
public class GroupMapper implements MariaMapper<Group, SearchFilter> {
	...
	@Override
	public Group map(int index, ResultSet rs, StatementContext sc)
			throws SQLException {
		Group obj = new Group();
	...
	@Override
	public Map<String, Object> convertToDao(Group dto) {
